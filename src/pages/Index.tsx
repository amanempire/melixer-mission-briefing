...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-melixer-darker overflow-x-hidden">
      ...
      {/* Hero Section */}
      <Section fullHeight className="flex flex-col justify-center items-center relative overflow-hidden">
      ...
      {/* What is Melixer */}
      <Section id="what" className="bg-melixer-dark">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-on-scroll opacity-0">
            ...
            <p className="text-melixer-light/80 mb-6">
              Melixer bridges the gap between <span className="text-melixer-purple font-semibold">ideas</span> and <span className="text-melixer-blue font-semibold">skills</span>, 
              creating a collaboration platform for founders and talented contributors to find each other.
            </p>
            <p className="text-melixer-light/80">
              We believe great companies are built by exceptional teams, not just great ideas. 
              Melixer creates a space where these connections happen more efficiently and transparently.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-melixer-light/70 text-sm">Founders with brilliant ideas often lack the technical skills to bring them to life.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-melixer-light/70 text-sm">Talented individuals with technical skills seek meaningful projects to work on.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-melixer-light/70 text-sm">Our platform creates the perfect environment for collaboration, leading to stronger startups.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* For Founders */}
      <Section id="founders" enableGrid className="bg-melixer-darker">
        <FeatureColumns
          title="For Founders"
      ...
      {/* How It Works */}
      <Section enableGrid className="bg-melixer-darker">
      ...
      {/* Beta Call */}
      <Section className="bg-melixer-dark">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-on-scroll opacity-0">
            ...
            <p className="text-melixer-light/80 mb-6">
              We're launching with a small, curated group of founders and contributors to ensure quality connections and a smooth experience.
            </p>
            <p className="text-melixer-light/80 mb-8">
              Apply below to join our exclusive beta and get early access to Melixer's platform. Be part of shaping how the next generation of startups are built.
            </p>
      ...
      {/* Who This is Not For */}
      <Section className="bg-melixer-darker">
        <div className="text-center mb-12 animate-on-scroll opacity-0">
      ...
      <Section className="bg-gradient">
        <div className="text-center max-w-3xl mx-auto animate-on-scroll opacity-0">
          ...
          <p className="text-white/90 mb-8 text-lg">
            Help us redefine how startups find their ideal teams and how talented individuals find meaningful projects to work on.
          </p>
      ...
      <footer className="bg-melixer-darker py-8 border-t border-white/10">
        <div className="container text-center">
          ...
          <p className="text-melixer-light/60 text-sm">© 2025 Melixer. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
